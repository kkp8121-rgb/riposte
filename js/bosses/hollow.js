...
(function (global) {
  ...
  var HOLLOW = {
    ...
    hp: 300,
    par: 60,                    // 2026-09-23 재설계 실측: 숙련 승 27.5~34.7s ×2 ≈ 55~69 · 완벽 20.5~24.7s > 60/3. docs/qa/balance-2026-09-23.md
    armor: false,
    spawnX: 720,
    droneHz: 40,
    ...
    /* ---- 공격 테이블 (스펙 §3.11 · 2026-09-23 재설계 §2.4) ----------------------------------------
