...
- 구현 계획: `docs/superpowers/plans/2026-09-17-riposte-chapter2-story.md` · `docs/superpowers/plans/2026-09-18-riposte-chapter2-redesign.md` · `docs/superpowers/plans/2026-09-19-riposte-chapter3.md`
- 밸런스 실측: `docs/qa/balance-2026-09-17.md`(구 기반, 폐기) · `docs/qa/balance-2026-09-18.md`(챕터 2 확정) · `docs/qa/balance-2026-09-19.md`(챕터 3 확정, 3시드)
