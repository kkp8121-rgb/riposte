...
- 갱신: 2026-09-17
- 상태: 8보스(챕터 2개) + 헬테이커식 단문 대화(STORY) 완성본. GitHub `kkp8121-rgb/riposte` (Public) → Pages `https://kkp8121-rgb.github.io/riposte/`
...
- 챕터 2 밸런스 최종(2026-09-17): LANTERN HP 280/par 60s, CHORUS HP 300/par 45s, BASTION HP 310/par 50s, AVARICE HP 400/par 55s. 실측·레버 기록은 `docs/qa/balance-2026-09-17.md` — 완벽 봇 8/8 S/A, 숙련 프로파일 8/8 승리.
...
- **BASTION HP 290 후보**: 이번엔 340→310으로만 낮췄다. 여유가 더 필요하면 290도 후보로 남아 있다(추가 실측 필요 — 완벽 봇이 너무 쉬워지는지 확인 후 채택).
